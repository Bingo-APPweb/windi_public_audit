...
Es ist keine Bestrafung — es ist der Schutz des WINDI-LAW-Ökosystems
...
It is not punishment — it is protection of the WINDI-LAW ecosystem
...
Não é punição — é protecção do ecossistema WINDI-LAW
