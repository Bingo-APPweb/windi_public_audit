...
Die Verifizierung bei WINDI-LAW ist kein automatisches Recht.
...
Verification at WINDI-LAW is not an automatic right.
...
A verificação no WINDI-LAW não é um direito automático.
