  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {data.ai && (
          <div style={{
            fontFamily: jm, fontSize: "0.7rem", color: "#A0A0A0", marginBottom: "12px",
          }}>{data.ai}</div>
        )}
        <div style={{
...
function ConsensusPulse({ t }) {
  ...
  return (
    <div style={{
      ...
      {pulses.map((pulse, i) => (
        <div key={pulse.id} style={{
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{
              fontFamily: jm, fontSize: "0.55rem", color: "#9A9A9A", marginTop: "2px",
            }}>
              #{pulse.hash}
            </div>
          </div>
      ...
      {pulses.length === 0 && (
        <div style={{
          fontFamily: jm, fontSize: "0.65rem", color: "#9A9A9A",
        ...
        return (
          <div key={inv.id} style={{
            ...
            <div style={{
              ...
              color: isVerified ? (isI9 ? "#EF4444" : "#10B981") : "#6B6560",
            ...
            <div style={{
              ...
              color: isVerified ? (isI9 ? "#EF4444" : "#AAA") : "#6B6560",
              lineHeight: 1.3,
            }}>
              {inv.desc}
            </div>
...
function DNATransparencyPanel({ lang: externalLang, setLang: externalSetLang, onComplete }) {
    ...
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: "900px", margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "48px", animation: "fadeInUp 1s ease" }}>
          ...
          <div style={{ fontFamily: of_, fontSize: "0.85rem", fontWeight: 200, color: "#8A8A8A", marginTop: "12px", maxWidth: "550px", margin: "12px auto 0", lineHeight: 1.6 }}>
            {t.intro}
          </div>
        </div>
        ...
        <div style={{
          ...
          <section style={{ animation: "fadeInUp 1s ease 0.4s both" }}>
            <div style={{ marginBottom: "16px" }}>
              ...
              <div style={{ fontFamily: of_, fontSize: "0.75rem", fontWeight: 300, color: "#A0A0A0", lineHeight: 1.5 }}>
                {t.consensusIntro}
              </div>
            </div>
            <ConsensusPulse t={t} />
        ...
        <div style={{
          ...
          <div style={{ fontFamily: jm, fontSize: "0.55rem", color: "#8A8A8A", marginTop: "16px" }}>
            {t.sealAuthor}
          </div>
        </div>
