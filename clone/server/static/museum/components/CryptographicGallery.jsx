...
function CryptographicGallery({ lang: externalLang, setLang: externalSetLang, onComplete }) {
    ...
    return (
      <div style={{
        ...
        <div style={{ animation: "fadeInUp 2s ease", textAlign: "center" }}>
          ...
          <div style={{ fontFamily: jm, fontSize: "0.65rem", color: "#9A9A9A", marginTop: "24px" }}>SOVEREIGNTY ACTIVE</div>
    ...
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: "800px", margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "48px", animation: "fadeInUp 1s ease" }}>
          ...
          <div style={{ fontFamily: of_, fontSize: "0.85rem", fontWeight: 200, color: "#8A8A8A", marginTop: "12px", maxWidth: "500px", margin: "12px auto 0", lineHeight: 1.6 }}>
            {t.intro}
          </div>
        </div>
        ...
        <section style={{ marginBottom: "80px", animation: "fadeInUp 1s ease 0.2s both" }}>
          <div style={{ textAlign: "center", marginBottom: "24px" }}>
            ...
            <div style={{ fontFamily: of_, fontSize: "0.8rem", fontWeight: 300, color: "#A0A0A0", fontStyle: "italic" }}>"{t.station1Text}"</div>
          </div>

          <PixelPulse t={t} />

          <div style={{ textAlign: "center", marginTop: "16px" }}>
            <div style={{ fontFamily: jm, fontSize: "0.55rem", color: "#9A9A9A", letterSpacing: "0.1em" }}>{t.station1Hint}</div>
            <div style={{ fontFamily: of_, fontSize: "0.75rem", fontWeight: 300, color: "#8A8A8A", marginTop: "12px", maxWidth: "420px", margin: "12px auto 0", lineHeight: 1.6 }}>
              {t.station1Reveal}
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: "80px", animation: "fadeInUp 1s ease 0.4s both" }}>
          <div style={{ textAlign: "center", marginBottom: "24px" }}>
            ...
            <div style={{ fontFamily: of_, fontSize: "0.8rem", fontWeight: 300, color: "#A0A0A0", fontStyle: "italic" }}>"{t.station2Text}"</div>
          </div>
          ...
          {sculptureRevealed && (
            <div style={{
              ...
              <div style={{ fontFamily: jm, fontSize: "0.55rem", color: "#8A8A8A", marginBottom: "12px" }}>{t.station2Origin}</div>
              <div style={{ fontFamily: of_, fontSize: "0.75rem", fontWeight: 300, color: "#A0A0A0", lineHeight: 1.6 }}>{t.station2Detail}</div>
            </div>
          )}
        </section>
        ...
        <section style={{ marginBottom: "80px", animation: "fadeInUp 1s ease 0.6s both" }}>
          <div style={{ textAlign: "center", marginBottom: "24px" }}>
            ...
            <div style={{ fontFamily: of_, fontSize: "0.8rem", fontWeight: 300, color: "#A0A0A0", fontStyle: "italic" }}>"{t.station3Text}"</div>
          </div>

          <div style={{ textAlign: "center", marginBottom: "12px" }}>
            <div style={{ fontFamily: jm, fontSize: "0.55rem", color: "#9A9A9A", letterSpacing: "0.1em" }}>{t.station3Hint}</div>
          </div>
          ...
          <div style={{
            ...
            fontSize: "0.75rem", fontWeight: 300, color: "#8A8A8A", maxWidth: "420px",
        ...
        <div style={{ textAlign: "center", padding: "24px 24px 60px" }}>
          ...
          <div style={{ marginTop: "12px", fontFamily: of_, fontSize: "0.75rem", color: "#9A9A9A", fontWeight: 200 }}>{t.enterSub}</div>
          <div style={{ marginTop: "24px", fontFamily: jm, fontSize: "0.5rem", color: "#7A7A7A", letterSpacing: "0.15em", animation: "pulseNeon 3s ease infinite" }}>
            {t.zeroHour}
          </div>
        </div>
        ...
        <div style={{ textAlign: "center", padding: "20px", borderTop: "1px solid rgba(255,255,255,0.03)" }}>
          <div style={{ fontFamily: bg, fontSize: "0.7rem", fontWeight: 300, color: "#9A9A9A", letterSpacing: "0.2em", textTransform: "uppercase" }}>{t.principle}</div>
        </div>
      </div>
    </div>
  );
