    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
        ...
        <div>
          <div style={{
            ...
            color: isActive ? "#D4AF37" : "#444", letterSpacing: "0.3em", textTransform: "uppercase",
          }}>
            {station.year}
          </div>
          <div style={{
      ...
      {expanded && (
        <div style={{
          ...
          color: "#666", lineHeight: 1.7, paddingTop: "16px",
...
export default function GenesisMuseum({ lang: externalLang, setLang: externalSetLang, onComplete }) {
    ...
    return (
      <div style={{
        ...
        <div style={{ animation: "fadeInUp 2s ease", textAlign: "center" }}>
          ...
          <div style={{ fontFamily: jm, fontSize: "0.65rem", color: "#333", marginTop: "24px" }}>
            EDITOR LOADING...
          </div>
          <div style={{
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 2, padding: "40px 0" }}>
        ...
        <div style={{ marginBottom: "60px" }}>
          <div style={{
            fontFamily: jm, fontSize: "0.55rem", color: "#333", textAlign: "center",
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontFamily: jm, fontSize: "0.55rem", color: "#444", letterSpacing: "0.4em", textTransform: "uppercase", marginBottom: "8px" }}>
              {t.altarTitle}
            </div>
            <div style={{ fontFamily: of_, fontSize: "0.8rem", fontWeight: 200, color: "#666", marginBottom: "28px" }}>
              {t.altarSub}
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "48px", marginTop: "24px", flexWrap: "wrap" }}>
              <div style={{ textAlign: "center" }}>
                ...
                <div style={{ fontFamily: jm, fontSize: "0.55rem", color: "#555", marginTop: "4px", fontStyle: "italic" }}>{t.altarLakshmi}</div>
              </div>
              <div style={{ textAlign: "center" }}>
                <div style={{ fontFamily: of_, fontSize: "0.78rem", color: "#AAA", fontWeight: 300 }}>{t.altar4}</div>
                <div style={{ fontFamily: jm, fontSize: "0.55rem", color: "#555", marginTop: "4px", fontStyle: "italic" }}>{t.altarNarayana}</div>
              </div>
            </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontFamily: jm, fontSize: "0.55rem", color: "#444", letterSpacing: "0.4em", textTransform: "uppercase", marginBottom: "24px" }}>
              {t.mirrorTitle}
            </div>
            ...
            <div style={{ fontFamily: of_, fontSize: "0.8rem", fontWeight: 300, color: "#555", lineHeight: 1.7, maxWidth: "440px", margin: "0 auto 24px" }}>
              {t.mirrorDetail}
            </div>
            ...
            <div style={{
              ...
              fontFamily: jm, fontSize: "0.52rem", color: "#2A2A2A", textAlign: "left", lineHeight: 2,
            }}>
              <div>BIRTH — <span style={{ color: "#444" }}>{birthHash}</span></div>
              <div>PURPOSE — <span style={{ color: "#444" }}>{purposeHash}</span></div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          {/* Hash trail hint */}
          <div style={{ marginTop: "32px", fontFamily: jm, fontSize: "0.5rem", color: "#222", letterSpacing: "0.15em" }}>
            {t.hashTrail}
          </div>
        </div>
