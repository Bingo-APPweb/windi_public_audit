...
W-ENTERPRISE-001 (:8150) + WINDI-SITES (:8122)
...
# ══════════════════════════════════════════════════════════════════════════════
# PATCH B — WINDI-SITES · law_canvas_patch.py
...
async def law_generate_document_cover(
    ...
    try:
        ...
        logging.getLogger("windi-sites").warning(f"Canvas offline: {e}")
    return None
