# WINDI-SITES — Refusal Process v1.0
...
Es ist keine Bestrafung — es ist der Schutz des WINDI-SITES-Ökosystems
...
curl -X POST http://127.0.0.1:8101/api/receipts \
  ...
  -d '{
    "id": "WINDI-SITES-REFUSED-{did[:8].upper()}",
...
It is not punishment — it is protection of the WINDI-SITES ecosystem
...
Não é punição — é protecção do ecossistema WINDI-SITES
