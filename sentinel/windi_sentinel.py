...
SERVICE_REGISTRY = [
    ...
    # ─── ECOSYSTEM SERVICES (8100-8108) — Added 21Feb26 ───────
    {
        "name": "windi-desktop",
        "display": "Desktop D1",
        "systemd_unit": "windi-desktop.service",
        "port": 8100,
        "health_endpoint": "/api/health",
        "health_method": "http",
        "critical": True,
        "description": "WINDI Desktop — governance-aware document editing",
    },
    {
        "name": "windi-ledger",
        "display": "Forensic Ledger",
        "systemd_unit": "windi-ledger.service",
        "port": 8101,
        "health_endpoint": "/health",
        "health_method": "http",
        "critical": True,
        "description": "Forensic Ledger API — immutable record keeping",
    },
    {
        "name": "windi-sentinel-law",
        "display": "Sentinel LAW",
        "systemd_unit": "windi-sentinel-law.service",
        "port": 8102,
        "health_endpoint": "/health",
        "health_method": "http",
        "critical": True,
        "description": "Sentinel LAW — permanent governance invariants",
    },
    {
        "name": "windi-export",
        "display": "Export Engine",
        "systemd_unit": "windi-export.service",
        "port": 8103,
        "health_endpoint": "/health",
        "health_method": "http",
        "critical": False,
        "description": "M3 Export Engine — JMPG bundle generation",
    },
    {
        "name": "windi-viewer",
        "display": "JMPG Viewer",
        "systemd_unit": "windi-viewer.service",
        "port": 8104,
        "health_endpoint": "/health",
        "health_method": "http",
        "critical": False,
        "description": "JMPG Viewer — sovereign document rendering",
    },
    {
        "name": "windi-communique",
        "display": "Communiqué Engine",
        "systemd_unit": "windi-communique.service",
        "port": 8105,
        "health_endpoint": "/health",
        "health_method": "http",
        "critical": True,
        "description": "Communiqué Engine — official announcements",
    },
    {
        "name": "windi-vault",
        "display": "Forensic Vault",
        "systemd_unit": "windi-vault.service",
        "port": 8106,
        "health_endpoint": "/health",
        "health_method": "http",
        "critical": True,
        "description": "Forensic Vault — evidence storage and verification",
    },
    {
        "name": "windi-landing-pmg",
        "display": "Landing P/M/G",
        "systemd_unit": "windi-landing-pmg.service",
        "port": 8107,
        "health_endpoint": "/health",
        "health_method": "http",
        "critical": False,
        "description": "Landing page — Pequeno/Médio/Grande entry points",
    },
    {
        "name": "windi-palette",
