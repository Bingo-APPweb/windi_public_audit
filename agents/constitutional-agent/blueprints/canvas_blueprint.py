...
def engine_d_json_to_html(data: dict, theme_name: str = "klar") -> str:
    ...
    footer_text = data.get("footer_text", "This document is a cryptographic proof of integrity generated by the WINDI Sovereign Protocol (Kempten, Bavaria, DE). Any modification to the underlying data will invalidate this certificate. Verified in accordance with BaFin MaRisk requirements and eIDAS Regulation (EU) 910/2014.")
