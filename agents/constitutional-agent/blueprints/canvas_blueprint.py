...
def engine_d_json_to_html(data: dict, theme_name: str = "klar") -> str:
    ...
    # CANONICAL FOOTER — German jurisdiction disclaimer (hardcoded for legal consistency)
    # LLM-generated footer_text is ignored to ensure regulatory compliance
    footer_text = "This document is a cryptographic proof of integrity generated by the WINDI Sovereign Protocol (Kempten, Bavaria, DE). Any modification to the underlying data will invalidate this certificate. Verified in accordance with BaFin MaRisk requirements and eIDAS Regulation (EU) 910/2014."
...
.footer{{text-align:center;font-size:9px;color:{t['text_secondary']};border-top:1px solid {t['border']};padding-top:16px;line-height:1.6;max-width:600px;margin:0 auto}}
