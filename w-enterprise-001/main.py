...
try:
    ...
    from vera_langfuse import create_langfuse_router, LANGFUSE_ENABLED
    ...
    app.include_router(create_langfuse_router())
    ...
    log.info(f"[VERA v1.2] Langfuse Observability: {'ENABLED' if LANGFUSE_ENABLED else 'DISABLED'} — §204.6")
