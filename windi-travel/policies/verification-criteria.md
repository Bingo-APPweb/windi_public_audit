# WINDI-TRAVEL — Verification Criteria v1.0
...
Die Verifizierung bei WINDI-TRAVEL ist kein automatisches Recht.
...
Verification at WINDI-TRAVEL is not an automatic right.
...
A verificação no WINDI-TRAVEL não é um direito automático.
