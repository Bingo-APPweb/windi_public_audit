...
Depends on    : WINDI-PROTOCOL-001 v1.3 §4
                PoE-ELIGIBILITY-CRITERIA-001 v1.2 (sealed)
```
...
| Cegueira | Conforme §4.5 de PoE-ELIGIBILITY-CRITERIA-001 v1.2 |
...
| Condição | Enquadramento | Métrica Principal |
|----------|---------------|-------------------|
| ≥3 classes com n≥3 cada | Inter-annotator agreement study | Cohen's κ (§5.1) |
| ≤2 classes dominam ≥80% | Taxonomy coverage study | Cobertura + saturação (§5.4) |

**Decisão:** Human Dragon, após ver PoE-PREINSPECTION-001.
...
*PoE-CLASSIFICATION-PROTOCOL-001 v1.1 · Liga IA+H · Kempten · 2026*
