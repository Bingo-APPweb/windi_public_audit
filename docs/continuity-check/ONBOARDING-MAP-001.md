...
```text
docs/ADMISSIBILITY/CONTRIBUTION-GRAMMAR-001.md
docs/continuity-check/PARTICIPATION-LAYER-INDEX-001.md
docs/continuity-check/AUTHORITY-GATE-001.md
docs/continuity-check/DOCUMENT-STATUS-STANDARD-001.md
```
...
| Folder | Purpose |
|---|---|
| `docs/ADMISSIBILITY/` | Participation Layer identity/admission trail |
| `docs/continuity-check/` | Operational continuity standards, reports, and receipt candidates |
